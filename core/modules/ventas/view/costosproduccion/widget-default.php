...
<div class="btn-group  pull-right">
	<a href="index.php?view=newcostosproduccion" class="btn btn-default">Agregar Costos de Hectarea </a>
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="../products/report/products-word.php">Word 2007 (.docx)</a></li>
		...
		<h1>Lista de Costos de Hectarea</h1>
...
if($px>0):
?>
<a class="btn btn-sm btn-default" href="<?php echo "../products/index.php?view=products&limit=$limit&page=".($px); ?>"><i class="glyphicon glyphicon-chevron-left"></i> Atras </a>
<?php endif; ?>
...
if($px<=$npaginas):
?>
<a class="btn btn-sm btn-default" href="<?php echo "../products/index.php?view=products&limit=$limit&page=".($px); ?>">Adelante <i class="glyphicon glyphicon-chevron-right"></i></a>
<?php endif; ?>
</div>
<div class="clearfix"></div>
...
<div class="clearfix"></div>
	...
	?>
	<div class="jumbotron">
		<h2>No hay Guias de Remisión</h2>
		<p>No se han agregado guias de remisión a la base de datos, puedes agregar uno dando click en el boton <b>"Agregar Guias"</b>.</p>
	</div>
	<?php
}
