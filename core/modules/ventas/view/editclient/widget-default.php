    ...
    <div class="col-md-12">
        ...
        <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updateclient" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" name="address1" value="<?php echo $user->address1;?>" class="form-control"
                        required id="username" placeholder="Direccion">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 control-label">Email*</label>
                <div class="col-md-6">
                    <input type="text" name="email1" value="<?php echo $user->email1;?>" class="form-control" id="email"
                        placeholder="Email">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="number" name="phone1" value="<?php echo $user->phone1;?>" class="form-control"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="number" name="sueldo" value="<?php echo $user->sueldo;?>" class="form-control"
                        id="sueldo" placeholder="Telefono">
                </div>
            </div>
