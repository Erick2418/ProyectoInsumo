...
<head>
  ...
  <title>SIS. AGRICOLA | Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>SIS.</b> INVENTARIO</span>
...
<li><a href="guiaremision.php"><i class="fa fa-circle-o"></i> Guia de Remisión</a></li>
...
if ($_SESSION['consultav']==1) {
  echo '<li class="treeview">
          <a href="#">
            <i class="fa fa-usd"></i> <span>Hectárea </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="resultadohectarea.php"><i class="fa fa-circle-o"></i> Resultado Operativo</a></li>
<li><a href="costohectarea.php"><i class="fa fa-circle-o"></i> Costo por Hectarea</a></li>
          </ul>
        </li>';
}
        ?>     
        ...
        <li><a href="https://api.whatsapp.com/send?phone=0994907388&text=Hola, Nececito mas informacion!"><i class="fa fa-question-circle"></i> <span>Ayuda</span><small class="label pull-right bg-yellow">Contacto</small></a></li>
